...
const SubmitButtonSection = ({
  ...
  return (
    ...
    >
      <Button
        className="w-full h-16 text-xl font-medium bg-primary hover:bg-primary text-white transition-all duration-300 rounded-xl shadow-lg hover:shadow-xl disabled:opacity-100 relative overflow-hidden group"
        disabled={isLoading}
        onClick={onSubmit}
      >
        {isLoading ? (
